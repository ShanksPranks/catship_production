...
$k1PublicKey = '041c4bc717563647d7980e5f46b79c3b68eb11667559f8b70ab07b737e985d33f078dd404e1abe0ffc752e9ebb1df1b38853f2d8a79ec54aaea91827779897c5a5';
$k1PrivateKey = '723a7e594b3cf567682fba1509cd74ee990484f10b6cde03e80f49be49c68822';


$sig2 = new \Phactor\Signature;
$signature2 = $sig2->generate('040560', $k1PrivateKey);
error_log('test using Phactor:');
error_log($signature2);
